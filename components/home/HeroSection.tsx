...
export function HeroSection({ settings }: HeroSectionProps) {
    ...
    return (
        <section className="relative h-[calc(100vh-64px)] min-h-[600px] flex items-center justify-center overflow-hidden">
            {/* Background Gradient - Richer depth */}
            <div className="absolute inset-0 bg-gradient-to-b from-primary-900 via-gray-900 to-black dark:from-black dark:via-gray-900 dark:to-primary-950" />
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-[10%] left-[10%] w-96 h-96 bg-gold-500/10 rounded-full blur-[120px] animate-float duration-[15s]" />
                <div className="absolute bottom-[10%] right-[10%] w-[500px] h-[500px] bg-primary-500/10 rounded-full blur-[150px] animate-float duration-[20s]" style={{ animationDelay: '-5s' }} />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gold-400/5 rounded-full blur-[100px]" />
            </div>
            ...
            <div className="container-custom relative z-10 -mt-10">
                <div className="max-w-4xl mx-auto text-center space-y-6">
                    ...
                    {/* Top Badge */}
                    <div className="inline-flex items-center gap-2 px-5 py-2 bg-white/5 backdrop-blur-md rounded-full border border-gold-400/20 animate-fade-in shadow-lg shadow-black/20">
                        <Sparkles className="w-4 h-4 text-gold-400" />
                        <span className="text-gold-200/90 text-sm font-medium tracking-wider">
                            সাহিত্যিক ঐতিহ্য
                        </span>
                    </div>
                    ...
                    <div className="animate-slide-up space-y-1">
                        <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold text-white tracking-tight leading-[1.1]">
                            {firstName}
                        </h1>
                        <h1
                    ...
                    <div className="max-w-2xl mx-auto backdrop-blur-sm bg-white/5 rounded-2xl p-6 border border-white/5 animate-fade-in stagger-3 hover:bg-white/10 transition-colors duration-500">
                        <p className="text-2xl md:text-3xl text-gold-100 font-bengali tracking-wide mb-3">
                            {occupation}
                        </p>

                        {heroDescription && (
                            <p className="text-lg text-gray-300 font-light italic font-serif leading-relaxed opacity-90 mb-4">
                                &quot;{heroDescription}&quot;
                            </p>
                        )}

                        <p className="text-sm text-gray-400 tracking-[0.2em] font-light uppercase border-t border-white/10 pt-4 inline-block px-10">
                            {bornDate} — {deathDate}
                        </p>
                    </div>
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 z-20 opacity-60 hover:opacity-100 transition-opacity cursor-pointer">
                <span className="text-[10px] text-white/40 tracking-[0.3em] uppercase">নিচে দেখুন</span>
